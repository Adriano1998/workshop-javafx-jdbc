...
public class SellerFormController implements Initializable {
	...
	private Seller getFormData() {
		...
		//jogando o conteudo da caixinha do id para o campo id do objeto.
		obj.setId(Utils.tryParseToInt( txtId.getText()));
		
		//testando se é igual a nulo ou string vazio.
		...
		//startofday vai converter a data que foi escolhida no pc do usuario para o instant que é uma data independente de localidade.
		//assim que pega o valor do datepicker.
		if(dpBirthDate.getValue() == null) {
			exception.addError("birthDate", "Field can´t be empty");
		}
		else {
			Instant instant = Instant.from(dpBirthDate.getValue().atStartOfDay(ZoneId.systemDefault()));
			//converter instant para o date.
	...
	private void setErrorMessages(Map<String, String> errors) {
		...
		//se não houver erro  o label fica com texto vazio.
